            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="mb-6 space-y-4">
                    <div>
                        ...
                        <p class="mt-1 text-gray-900">{{ $doctor->name }}</p>
                    </div>
                    <div>
                        <p class="text-sm font-medium text-gray-500">専門科</p>
                        <p class="mt-1 text-gray-900">{{ $doctor->specialty ?? '-' }}</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-gray-900">{{ $doctor->created_at->format('Y年m月d日 H:i') }}</p>
                    </div>
