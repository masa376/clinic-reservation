...
放射線技師として医療現場で勤務した経験をもとに設計・開発した、クリニック向けの予約管理Webアプリケーション。
医療現場で実際に必要とされる機能（アレルギー情報の管理・検査前注意事項の表示など）を盛り込み、現場目線の設計を意識。
...
放射線技師として医療現場での経験を経た後、Webエンジニアへのキャリアチェンジを目指す。
